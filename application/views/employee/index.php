                        ...
                        <?php if($rec!=null) {  ?>
                            ...
                            <?php foreach($rec as $r) {  ?>
                                ...
                                <tr class="<?php echo ($i%2==0) ? 'even' : 'odd'; ?> pointer">
                                    ...
                                    <td class=" "><?php echo $r->level_name; ?></td>
                                    <td class=" "><?php echo ($r->active) ? "Yes" : "No"; ?></td>

                                    <td class="a-center last text-center">
                                        <a class="btn btn-xs btn-info" href="<?php echo base_url().'employee/view/'.$r->id; ?>"><span class="fa fa-file"></span> View</a>
                                        <a class="btn btn-xs btn-warning" href="<?php echo base_url().'employee/edit/'.$r->id; ?>"><span class="fa fa-pencil"></span> Edit</a>
                                    </td>
                                </tr>
