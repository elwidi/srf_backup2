        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                ...
                <?php } ?>
                  ...
                  <form id = "srf_form" method = "POST" action="<?php echo base_url().'customer/srfv2/1'?>">
                    ...
                    <div id="wizard" class="form_wizard wizard_horizontal">
                      ...
                      <div id="step-3">
                        <div class="form-horizontal form-label-left form-step-3">
                          <div class="row">
                              ...
                              <div class="form-group parent">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="business_line" required name="business_line" class="form-control js-example-tags input possibly_other" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please select item">
                                      ...
                                      <br/><br/>
                                      <input type="text" id="" style = "width: 250px;" name="business_line2" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                            ...
                            <div class="col-md-6 col-xs-12">
                              <div class="form-group">
                                <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Customer Classification <span class="required">*</span> 
                                </label>
                              ...
                              <div class = "row">
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="sla_cem" class="form-control col-md-7 col-xs-12 input" type="text" name = "sla_cem">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="mttr" class="form-control col-md-7 col-xs-12 input" type="text" name = "mttr">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class = "row">
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="problem_notif" class="form-control col-md-7 col-xs-12 input" type="text" name = "problem_notif">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="mttu" class="form-control col-md-7 col-xs-12 input" type="text" name = "mtttu">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class = "row">
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="escalation" class="form-control col-md-7 col-xs-12 input" type="text" name = "escalation_level">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="reporting" class="form-control col-md-7 col-xs-12 input" type="text" name = "reporting">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class = "row">
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="single_contact" class="form-control col-md-7 col-xs-12 input" type="text" name = "single_contact">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input id="meeting" class="form-control col-md-7 col-xs-12 input" type="text" name = "meeting">
                                        <span id = "for_customer_classification"></span>
                                    </div>
                                  </div>
                                </div>
                              ...
                              <div class="col-md-6 col-xs-12">
                                <div class="row">
                                  <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="company_name" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[name]" required="required" data-parsley-errors-container="#for_company_name" data-parsley-error-message="Please fill company name" value="<?php if(empty($source)) {echo $customer->name;}?>">
                            ...
                            <div class = "row">
                              <div class="col-md-6 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input id="director_name" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[director_name]" required="required" data-parsley-errors-container="#for_director_name">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input id="company_director_email" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[director_email]" required="required" data-parsley-errors-container="#for_director_email">
                              ...
                              <div class="col-md-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input id="company_director_phone" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[director_phone]" required="required" data-parsley-errors-container="#for_director_phone">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-3 col-sm-2 col-xs-12">
                                        <input id="company_director_ext" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[director_ext]" required="required" data-parsley-errors-container="#for_director_ext">
                                        <span id = "for_director_ext"></span>

                                    </div>
                                    <label class="control-label col-md-2 col-sm-2 col-xs-6">Hp</label>
                                    <div class="col-md-4 col-sm-2 col-xs-12">
                                        <input id="company_director_hp" class="form-control col-md-7 col-xs-12 input company" type="text" name="company[director_hp]"data-parsley-errors-container="#for_director_hp">
                            ...
                            <div class = "row">
                                <div class="col-md-6 col-xs-12 dda">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                         <input id="c_building_name_c" class="form-control col-md-7 col-xs-12 company input" type="text" name="c_correspondence[building_name]" data-parsley-errors-container="#for_c_building_name_c" required="required" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                           <input id="c_floor_c" class="form-control col-md-7 col-xs-12 company input" type="text" name="c_correspondence[floor]" data-parsley-errors-container="#correspondence_floor_c_c" required="required" >
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <textarea id="c_address_c" name="c_correspondence[address]" class="form-control company input" required="required" data-parsley-errors-container= "#for_c_address_c" required="required"><?php if(empty($source)) {echo $customer->address;}?></textarea>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <!-- <input id="subdistrict_c" class="form-control col-md-7 col-xs-12 subdistrict_text" type="text" name="c_correspondence[subdistrict]"> -->
                                ...
                                <div class="col-md-6 col-xs-12 dda">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                         <input id="building_name_b_c" class="form-control col-md-7 col-xs-12 input company" type="text" name="c_billing[building_name]" data-parsley-errors-container="#building_name_b_c">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                           <input id="floor_b_c" class="form-control col-md-7 col-xs-12 input company" type="text" name="c_billing[floor]" data-parsley-errors-container="#for_floor_b_c">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <textarea id="address_b_c" name="c_billing[address]" class="form-control input company" data-parsley-errors-container="#for_address_b_c"><?php if(empty($source)) {echo $customer->address;}?></textarea>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <!-- <input id="subdistrict_b" class="form-control col-md-7 col-xs-12 city_text" type="hidden" name="c_billing[subdistrict]" data-parsley-errors-container="#for_subdistrict_b"> -->
                            ...
                            <div class="row">
                              <div class="col-md-6 col-xs-12 dda">
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12">Name <span class="required">*</span></label>
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input id="personal_name" class="form-control col-md-7 col-xs-12 input person" type="text" name="personal[name]" required="required" data-parsley-errors-container="#for_personal_name" value="<?php if(empty($source)) {echo $customer->name;}?>">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <input id="personal_birthday" class="form-control col-md-7 col-xs-12 input person single_date" type="text" name="personal[birthday]" data-parsley-errors-container="#for_personal_birthday">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                        <textarea id="personal_address" name="personal[address]" class="form-control input person" required="required" data-parsley-errors-container="#for_personal_address" data-parsley-error-message="Please fill personal address"><?php if(empty($source)) {echo $customer->address;}?></textarea>
                            ...
                            <div class = "row">
                                <div class="col-md-6 col-xs-12 dda">
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-md-9 col-sm-6 col-xs-12">
                                         <input id="building_name_c" class="form-control col-md-7 col-xs-12 input person" type="text" name="p_correspondence[building_name]" required="required" data-parsley-errors-container="#for_c_building_name">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                           <input id="floor_c" class="form-control col-md-7 col-xs-12 input person" type="text" name="p_correspondence[floor]" required="required" data-parsley-errors-container="#correspondence_floor">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <textarea id="address_c" name="p_correspondence[address]" class="form-control" required="required" data-parsley-errors-container="#for_address_c"><?php if(empty($source)) {echo $customer->address;}?></textarea>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <!-- <input id="subdistrict_c" class="form-control col-md-7 col-xs-12 input" type="text" name="p_correspondence[subdistrict]" required="required" data-parsley-errors-container="#for_subdistrict_c"> -->
                                ...
                                <div class="col-md-6 col-xs-12 dda">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                           <input id="floor_b" class="form-control col-md-7 col-xs-12 input person" type="text" name="p_billing[floor]" required="required" data-parsley-errors-container="#for_floor_b">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <textarea id="address_b" name="p_billing[address]" class="form-control input person" required="required" data-parsley-errors-container="#for_address_b"><?php if(empty($source)) {echo $customer->address;}?></textarea>
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                         <!--  <input id="subdistrict_b" class="form-control col-md-7 col-xs-12 input" type="text" name="p_billing[subdistrict]" required="required" data-parsley-errors-container="#for_subdistrict_b"> -->
                      ...
                      <div id="step-5">
                        <div class="form-horizontal form-label-left form-step-5">
                          ...
                          <div class = "services" style="height: 1600px;">
                            <div class="row panel_service">
                              <div class="x_panel ">
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="product_class0" name="mservice[0][product_classification]" class="form-control js-example-tags input product_class" class="form-control js-example-tags input" rowidf = "0">
                                              <option value="">-- Select --</option>
                                              <?php foreach($service_group as $i => $sg) {?>
                                              <option value="<?php echo $sg->id?>"><?php echo $sg->group_name?></option>
                                              <?php } ?>
                                          </select>
                                      </div>
                                    </div>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="product_subclassification0" name="mservice[0][product_subclassification]" class="form-control js-example-tags input subclass_product" data-parsley-errors-container="#for_customer_classification">
                                              <!-- <option value="">-- Select --</option>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="col-md-9 col-sm-6 col-xs-12">
                                      <select id="product_name0" name="mservice[0][product_name]" class="form-control js-example-tags input" class="form-control js-example-tags input" style="width: 960px;">
                                          <option value="">-- Select --</option>
                                      </select>
                                  </div>
                                </div>
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <input id="capacity0" class="form-control col-md-7 col-xs-12 input" type="text" name="mservice[0][capacity]" required="required" data-parsley-errors-container="#for_rfs_date">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="uom0" name="mservice[0][uom]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="type_order0" name="mservice[0]['type_order']" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="billing_type0" name="mservice[0][billing_type]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="type_service0" name="mservice[0][type_service]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="service_purpose0" name="mservice[0][service_purpose]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="service_status0" name="mservice[0][service_status]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="service_owner0" name="mservice[0][service_owner]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="product_sla0" name="mservice[0][product_sla]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="sla_restitution0" name="mservice[0][sla_restitution]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-3 col-sm-6 col-xs-12">
                                          <input id="rfs_date0" class="form-control col-md-7 col-xs-12 input single_date" type="text" name="mservice[0][rfs_date]" required="required" data-parsley-errors-container="#for_rfs_date">
                                      </div>
                                      <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">End of Temporary Service 
                                      </label>
                                      <div class="col-md-3 col-sm-6 col-xs-12">
                                          <input id="end_temporary0" class="form-control col-md-7 col-xs-12 input single_date" type="text" name="mservice[0][end_temporary]" data-parsley-errors-container="#for_rfs_date">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-3 col-sm-4 col-xs-12">
                                          <select id="duration_contract" name="mservice[0][duration_contract]" class="form-control input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                      ...
                                      <div class="col-md-3 col-sm-4 col-xs-12">
                                          <select id="contract_uom0" name="mservice[0][contract_uom]" class="form-control input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                              <option value = "day">day</option>
                                              <option value = "week">week</option>
                                              <option value = "month">month</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="service_layer0" name="mservice[0][service_layer]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                              <option value = "1">1</option>
                                              <option value = "2">2</option>
                                              <option value = "3">3</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="media0" name="mservice[0][media]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                ...
                                <div class = "row">
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="interface0" name="mservice[0][interface]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="connection_method0" name="mservice[0][connection_method]" class="form-control js-example-tags input" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                  ...
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12 parent">
                                          <select id="protocol_technology0" name="mservice[0][protocol_technology]" class="form-control js-example-tags input possibly_other" class="form-control js-example-tags input" data-parsley-errors-container="#for_customer_classification">
                                          ...
                                          <input type="text" id="" style = "width: 250px;" name="mservice[0][protocol_technology2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                      </div>
                                    </div>
                                  </div>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12 parent">
                                          <select id="cpe_equipment0" name="mservice[0][cpe_equipment]" class="form-control js-example-tags input possibly_other" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                              <option value = "STB">STB</option>
                                          ...
                                          <input type="text" id="" style = "width: 250px;" name="mservice[0][cpe_equipment2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                ...
                                <div class = "row">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="backbone_protection0" name="mservice[0][backbone_protection]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="access_protection0" name="mservice[0][access_protection]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                              <option value = "SINGLE LINK">SINGLE LINK</option>
                                              <option value = "DOUBLE LINK">DOUBLE LINK</option>
                                              <option value = "TRIPLE LINK">TRIPLE LINK</option>
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="lastmile_protection0" name="mservice[0][lastmile_protection]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                              <option value = "SINGLE LINK"> SINGLE LINK</option>
                                              <option value = "DOUBLE LINK"> DOUBLE LINK</option>
                                              <option value = "TRIPLE LINK"> TRIPLE LINK</option>
                                ...
                                <div class = "row">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12 parent">
                                          <select id="equipment_protection0" name="mservice[0][equipment_protection]" class="form-control input possibly_other" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                          ...
                                          <input type="text" id="" style = "width: 150px;" name="mservice[0][equipment_protection2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                          
                                      </div>
                                      <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Security Protection 
                                      </label>
                                      <div class="col-md-2 col-sm-6 col-xs-12 parent">
                                          <select id="security_protection0" name="mservice[0][security_protection]" class="form-control input possibly_other" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                          ...
                                          <input type="text" id="" style = "width: 150px;" name="mservice[0][security_protection2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                      </div>
                                      <label class="control-label col-md-2 col-sm-3 col-xs-12" for="first-name">Other Protection 
                                      </label>
                                      <div class="col-md-2 col-sm-6 col-xs-12 parent">
                                          <select id="other_protection0" name="mservice[0][other_protection]" class="form-control input possibly_other" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                          ...
                                          <input type="text" id="" style = "width: 150px;" name="mservice[0][other_protection2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                      </div>
                                    </div>
                                </div>
                                <div class = "row">
                                  <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12 parent">
                                          <select id="monitoring_tools0" name="mservice[0][monitoring_tools]" class="form-control input possibly_other" data-parsley-errors-container="#for_customer_classification">
                                              <option value="">-- Select --</option>
                                          ...
                                          <input type="text" id="" style = "width: 300px;" name="mservice[0][monitoring_tools2]" class="form-control col-md-9 col-xs-12 other_input hidden" placeholder = "Please input here" data-parsley-errors-container="#for_business_line" data-parsley-error-message="Please input field">
                                  ...
                                  <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <select id="service_managed0" name="mservice[0][service_managed]" class="form-control input" data-parsley-errors-container="#for_customer_classification">
                                              <option value = "MORATELINDO">MORATELINDO</option>
                                    ...
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-9 col-sm-6 col-xs-12">
                                          <div class="input-group">
                                            <input type="hidden" name = "mservice[0][item_code]" id = "itemcode0">
                                            <input type="text" class="form-control" name = "mservice[0][item_code_desc]" id = "itemcode_desc0">
                                ...
                                <div class = "row">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="billing_by0" name="mservice[0][billing_by]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                              <option value = "MORATELINDO" >MORATELINDO</option>
                                              <option value = "CUSTOMER" >CUSTOMER</option>
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="lastmile_by0" name="mservice[0][lastmile_by]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                              <option value = "MORATELINDO" >MORATELINDO</option>
                                              <option value = "CUSTOMER" >CUSTOMER</option>
                                              <option value = "BUILDING MANAGEMENT" >BUILDING MANAGEMENT</option>
                                      ...
                                      <div class="col-md-2 col-sm-6 col-xs-12">
                                          <select id="cpe_by0" name="mservice[0][cpe_by]" class="form-control input" data-parsley-errors-container="#for_customer_classification" style="width: 150px;">
                                              <option value="">-- Select --</option>
                                              <option value = "MORATELINDO" >MORATELINDO</option>
                                              <option value = "CUSTOMER" >CUSTOMER</option>
                                              <option value = "BUILDING MANAGEMENT" >BUILDING MANAGEMENT</option>
                                  ...
                                  <div class="col-md-6 col-xs-12 dda">
                                    <div class="row">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-6 col-xs-12">
                                                <select id="interconnection0" name="installation[0][interconnection_point]"  class="form-control js-example-tags input" >
                                                    <option value="">-- Select --</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="ne_site_id0" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_site_id]"data-parsley-errors-container="#for_ne_site_id">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="ne_floor0" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_floor]"data-parsley-errors-container="#for_ne_floor">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <textarea id="ne_address0" name="installation[0][ne_address]" class="form-control near"data-parsley-errors-container="#for_ne_address"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="ne_city" class="form-control col-md-7 col-xs-12 near city_text" type="hidden" name="installation[0][ne_city]">
                                            <select id="ne_city2"class="form-control js-example-tags input near city" data-parsley-errors-container="#for_ne_city" data-parsley-error-message="Please fill city">
                                              <option value="">-- Select --</option>
                                              <?php foreach($province as $k => $r){ ?>
                                              <option value="<?php echo $r['id'].'#'.$r['name'] ?>"><?php echo $r['name']?></option>
                                              <?php } ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="ne_district" class="form-control col-md-7 col-xs-12 near district_text" type="hidden" name="installation[0][ne_district]"data-parsley-errors-container="#for_ne_district">
                                            <select id="ne_district2"class="form-control js-example-tags input near district" data-parsley-errors-container="#for_ne_district" data-parsley-error-message="Please fill district">
                                              <option value="">-- Select --</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <!-- <input id="ne_subdistrict" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_subdistrict]"data-parsley-errors-container="#for_ne_subdistrict"> -->
                                            <select id="ne_subdistrict2"name="installation[0][ne_subdistrict]" class="form-control js-example-tags input near subdistrict" data-parsley-errors-container="#for_ne_subdistrict" data-parsley-error-message="Please fill subdistrict">
                                              <option value="">-- Select --</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-2 col-xs-12">
                                            <input id="ne_state" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_state]"data-parsley-errors-container="#for_ne_state">
                                            <span id = "for_ne_state"></span>
                                        </div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-6">ZIP Code </label>
                                        <div class="col-md-3 col-sm-2 col-xs-12">
                                            <input id="ne_zip_code" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_zip_code]" data-parsley-errors-container="#for_ne_zip_code">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-2 col-xs-12">
                                            <input id="ne_longitude" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_longitude]"data-parsley-errors-container="#for_ne_longitude">
                                        ...
                                        <div class="col-md-3 col-sm-2 col-xs-12">
                                            <input id="ne_latitude" class="form-control col-md-7 col-xs-12 near" type="text" name="installation[0][ne_latitude]"data-parsley-errors-container="#for_ne_latitude">
                                  ...
                                  <div class="col-md-6 col-xs-12 dda">
                                    <div class="row">
                                      <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-6 col-xs-12">
                                                <input id="ip_address0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][interconnection_address]" required="required" data-parsley-errors-container="#for_company_name" data-parsley-error-message="Please fill company name">
                                                <span id = "for_company_name"></span>
                                            </div>
                                      </div>
                                    </div>
                                    <div class="row">
                                      <div class="form-group">
                                            ...
                                            <div class="col-md-9 col-sm-6 col-xs-12">
                                                <input id="rack_id0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][rack_id]" data-parsley-errors-container="#for_company_name" data-parsley-error-message="Please fill company name">
                                                <span id = "for_company_name"></span>
                                            </div>
                                      </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                             <input id="fe_building_name0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_building_name]" data-parsley-errors-container="#for_fe_building" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                             <input id="fe_floor0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_floor]" data-parsley-errors-container="#for_fe_floor" required="required">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <textarea id="fe_address" name="installation[0][fe_address]0" class="form-control" name="installation[0][fe_floor]" data-parsley-errors-container="#for_fe_address" required="required"></textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="fe_city0" class="form-control col-md-7 col-xs-12 city_text" type="hidden" name="installation[0][fe_city]" data-parsley-errors-container="#for_fe_city"> 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <input id="fe_district0" class="form-control col-md-7 col-xs-12 district_text" type="hidden" name="installation[0][fe_district]" data-parsley-errors-container="#for_fe_district">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <!-- <input id="fe_subdistrict0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_subdistrict]" data-parsley-errors-container="#for_fe_subdistrict"> -->
                                            <select id="fe_subdistrict0" class="form-control js-example-tags input near subdistrict" name="installation[0][fe_subdistrict]" data-parsley-errors-container="#for_fe_subdistrict" data-parsley-error-message="Please fill city" required="required">
                                              <option value="">-- Select --</option>
                                            </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-2 col-xs-12">
                                            <input id="fe_state0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_state]" data-parsley-errors-container="#for_fe_state" required="required">
                                            <span id = "for_fe_state"></span>
                                        </div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-6">ZIP Code 
                                        </label>
                                        <div class="col-md-3 col-sm-2 col-xs-12">
                                            <input id="fe_zip_code0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_zip_code]" data-parsley-errors-container="#for_fe_zip_code">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9 col-sm-6 col-xs-12">
                                            <div class="input-group">
                                              <input type="text" class="form-control" name = "installation[0][olt_booked]" id = "fe_fat_name0">
                                              <span class="input-group-btn">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 col-sm-2 col-xs-12">
                                            <input id="fe_longitude0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_longitude]" data-parsley-errors-container="#for_fe_longitude">
                                            <span id = "for_fe_longitude"></span>
                                        </div>
                                        <label class="control-label col-md-2 col-sm-2 col-xs-6">Latitude
                                        </label>
                                        <div class="col-md-3 col-sm-2 col-xs-12">
                                            <input id="fe_latitude0" class="form-control col-md-7 col-xs-12 input" type="text" name="installation[0][fe_latitude]" data-parsley-errors-container="#for_fe_latitude">
                        ...
                        <div class="form-horizontal form-label-left form-step-7">
                          ...
                          <table class="" style="width: 1100px;border:1px solid #000">
                            ...
                            <tbody>
                                ...
                                <!--Correspondence-->
                                <tr>
                                    <td rowspan = "8" style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000"><b>Correspondence Address </b></td>
                                    ...
                                    <td rowspan = "8" style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000"><b>Billing Address </b></td>
                                    <td style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000">Building Name</td>
                            ...
                            <tbody class="table_service">
                                ...
                                <tr>
                                    <td rowspan = "8" style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000"><b>Near End (Moratelindo/Third Party Site) </b></td>
                                    <td style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000">Building Name</td>
                                    <td style="padding: 5px 10px;color:#000;text-align: left;border:1px solid #000"><b></b></td>
                                    <td rowspan = "8" style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000"><b>Far End (Customer Site) </b></td>
                                    <td style="padding: 5px 10px;color:#000;text-align: left;font-weight:bold;border:1px solid #000">Building Name</td>
