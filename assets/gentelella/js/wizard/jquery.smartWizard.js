...
function SmartWizard(target, options) {
    ...
    var _init = function($this) {
        ...
        //  Prepare the steps
        _prepareSteps($this, $this.curStepIdx);
        // Show the first slected step
        _loadContent($this, $this.curStepIdx);
    };

    var _prepareSteps = function($this, currentStep) {
...
//            $($this.steps, $this.target).removeClass("selected").removeClass("disabled").addClass("done");
        ...
        $($this.steps, $this.target).each(function(i){
            ...
            {
                $($this.steps[i], $this.target).removeClass("done").removeClass("selected").addClass("disabled");
            }
        });
    };
    
    var _prepareStepsPrev = function($this, currentStep, prevStep) {
...
//        $($this.steps[prevStep], $this.target).removeClass("done").removeClass("selected").addClass("disabled");
//        console.log($this.steps[prevStep]);
    };
...
//            console.log(curStep);
        ...
        if(stepIdx > prevCurStepIdx){
            ...
            _prepareStepsPrev($this, $this.curStepIdx, prevCurStepIdx);
        }
